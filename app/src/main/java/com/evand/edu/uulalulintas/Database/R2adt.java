...
public class R2adt extends BaseAdapter {

    Context mContext;
    LayoutInflater inflater;
    private List<R2pasal> pasalList = null;
    private ArrayList<R2pasal> arraylist;

    public R2adt(Context context, List<R2pasal> pasalList) {
        mContext = context;
        this.pasalList = pasalList;
        inflater = LayoutInflater.from(mContext);
        this.arraylist = new ArrayList<R2pasal>();
    ...
    @Override
    public R2pasal getItem(int position) {
